...
namespace LinkGeek.Data.Migrations
{
    ...
    [Migration("20221009125911_AddFriendLists")]
    partial class AddFriendLists
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LinkGeek.Models.FriendLinkFriend", b =>
                {
                    b.HasOne("LinkGeek.AppIdentity.ApplicationUser", "User1")
                        .WithMany()
                        .HasForeignKey("User1Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LinkGeek.AppIdentity.ApplicationUser", "User2")
                        .WithMany("Friends")
